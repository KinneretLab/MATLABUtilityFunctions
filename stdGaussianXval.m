function [stdy ,  meany] = stdGaussianXval ( xi, yi, xval, sigma, toPlot);
% function [stdy ,  meany] = stdGaussianXval ( xi, yi, xval, sigma, varargin);
...
[meany] = meanGaussianXval(xi,yi,xval, sigma,0);
